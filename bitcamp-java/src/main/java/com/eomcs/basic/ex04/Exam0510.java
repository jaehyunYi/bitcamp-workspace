...
public class Exam0510 {
	public static void main(String[] args) {
		...
		int[] p = new int[3];	// c언어 (int*)malloc(sizeof(int) *malloc (memory allocation)
		// p 
		// - int 배열의 주소를 담는 변수이다.
...
//		System.out.println(x.length);
		...
		p2 = p; // p레퍼런스에 저장된 주소를 p2 레퍼런스에 복사한다.
		p2[1] = 1000;
		...
		p2 = null; // 주소 변수(레퍼런스)를 0 으로 초기화시키려면 null을 사용하라.		
		...
		int[] k6 ;
		// k6 = {111, 222, 333} //컴파일 오류! 변수 선언 없이는 생략 할 수 없다.
